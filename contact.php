                            ...
                            <div class="blog-posts fbt-item-post-wrap">
                                ...
                                <div class="blog-post fbt-item-post">
                                    ...
                                    <div class="post-body post-content">
                                        ...
                                        <form id="fbt-contact-form" class="contact-form" method="POST"
                                            action="index.html">
                                            <div class="row">
                                                <div class="col-md-9">
                                                    <div class="form-group">
                                                        <label for="name">Name*</label>
                                                        <input class="form-control shadow-none radius-0" id="name"
                                                            name="name" type="text">
                                                    </div>
                                                </div>
                                                <div class="col-md-9">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control shadow-none radius-0" id="mail"
                                                            name="mail" type="text">
                                                    </div>
                                                </div>
                                                <div class="col-md-9">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control shadow-none radius-0" id="website"
                                            ...
                                            <div class="row mb-4">
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <textarea class="form-control shadow-none radius-0" rows="9"
